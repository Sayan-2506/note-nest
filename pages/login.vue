<template>
    <div class="flex bg-zinc-900 h-screen">
        ...
        <div class="bg-black w-[516px] p-12 flex flex-col justify-center">
            ...
            <p class="text-zinc-300 text-sm mt-0.5">Don't have an account? <nuxt-link to="/register" class="font-bold text-[#FFAC00] underline">Sign up</nuxt-link> for one.</p>
            <form @submit.prevent="submit">
                ...
                <div>
                    <button
                        class="w-full mt-4 bg-[#FFAC00] rounded-full px-4 py-2 text-sm font-bold flex justify-center items-center space-x-2"><span>Log in</span>
                        <ArrowRight />
                    </button>
                </div>
                <!-- /sign up button -->
